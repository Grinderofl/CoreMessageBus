namespace CoreMessageBus.SqlServer
{
    public class SqlQueries
    {
        ...
        private string _peekFormat = "SELECT TOP (1) Id, MessageId, ContentType, Encoding, Data, Created, Deferred, Status FROM {0} WHERE (Deferred IS NULL OR Deferred < getdate()) AND Status = 'Queued'  ORDER BY Deferred ASC, Created DESC";
